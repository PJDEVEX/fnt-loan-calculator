...
let checkValues = () => {
    ...
    if(!interestRateValue.match(regexDecimalNumber)) {
        alert(`You entered ${interestRateInput.value} as INTEREST RATE. It shall be a number (e.g.: 5.00). Kindly recheck & enter!`);
    }
...
let updateChart = (totalInterestPayable, loanAmount) => {
    ...
    myChart.data.datasets[0].data[1] = totalAmount;   
    myChart.update();
};
